  ...
  return (
    <Component
      ...
      className={classnames(
        ...
        "bg-primary-500 text-light-background-900 inline-flex items-center hover:bg-light-background-50 transition duration-300 ease-in focus:ring-yellow-100 focus:ring-4 focus:ring-offset-1 rounded-xl px-5 py-2 font-xlBolder text-xl",
        className
      )}
      {...props}
    >
